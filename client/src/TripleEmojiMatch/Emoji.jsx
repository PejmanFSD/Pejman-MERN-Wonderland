...
export default function Emoji({imgId, imgSrc, emojis, setEmojis, selectedEmojis, setSelectedEmojis}) {
            ...
            if (selectedEmoji.isFilled === false) {
                setSelectedEmojis((currSelectedEmojis) =>
                    currSelectedEmojis.map((emoji) =>
                        ...
                        {...emoji, image: emojis.find((currEmoji) => currEmoji.id === imgId).image,  isFilled: true} :
                        emoji
                    )
                )
                break;
