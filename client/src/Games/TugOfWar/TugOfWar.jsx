...
import AboutTugOfWar from "./AboutTugOfWar";
  ...
  const userAct = () => {
    ...
    if (userColor === "Blue") {
      if (match?.indexOf(V2) - dice < 1) {
        ...
        setFinishedMatches((currFinishedMatches) => [
          ...currFinishedMatches,
          selectedMatch,
        ]);
        setAvailableMatches(
          availableMatches.filter((el) => el !== selectedMatch),
        );
      } else {
    ...
    if (!isUserTurn && isDiceUpdated && normalMode) {
      ...
      if (userColor === "Blue") {
        ...
        if (userScore === 0 && pejmanScore === 0) {
          ...
          if (
            matches[0]?.matchValue?.indexOf(V2) < 8 &&
            matches[1]?.matchValue?.indexOf(V2) < 8 &&
            matches[2]?.matchValue?.indexOf(V2) < 8
          ) {
            if (dice === 4 || dice === 5 || dice === 6) {
              // Choose user's best:
              if (
                matches[0]?.matchValue?.indexOf(V2) <=
                  matches[1]?.matchValue?.indexOf(V2) &&
                matches[0]?.matchValue?.indexOf(V2) <=
                  matches[2]?.matchValue?.indexOf(V2)
              ) {
          ...
          // We are in a beeter situation in all 3 matches:
            ...
            matches[0]?.matchValue?.indexOf(V2) > 7 &&
            matches[1]?.matchValue?.indexOf(V2) > 7 &&
            matches[2]?.matchValue?.indexOf(V2) > 7
          ) {
            // We can win 1 match:
            if (
              matches[0]?.matchValue?.indexOf(V2) + dice > 13 &&
              matches[1]?.matchValue?.indexOf(V2) + dice < 14 &&
              matches[2]?.matchValue?.indexOf(V2) + dice < 14
            ) {
              // Choose match1:
              setSelectedMatch(matches[0].matchName);
            } else if (
              matches[0]?.matchValue?.indexOf(V2) + dice < 14 &&
              matches[1]?.matchValue?.indexOf(V2) + dice > 13 &&
              matches[2]?.matchValue?.indexOf(V2) + dice < 14
            ) {
              // Choose match2:
              setSelectedMatch(matches[1].matchName);
              ...
              matches[0]?.matchValue?.indexOf(V2) + dice < 14 &&
              matches[1]?.matchValue?.indexOf(V2) + dice < 14 &&
              matches[2]?.matchValue?.indexOf(V2) + dice > 13
            ) {
              // Choose match3:
              setSelectedMatch(matches[2].matchName);
            }
        ...
        // Main Condition 2:
          ...
          if (
            matches
              .find((m) => m.matchName === matchA)
              ?.matchValue?.indexOf(V2) > 7 &&
            matches
              .find((m) => m.matchName === matchB)
              ?.matchValue?.indexOf(V2) > 7
          ) {
      ...
      // user's color is "Blue":
        ...
        if (userScore === 0 && pejmanScore === 0) {
          ...
          // We are in a beeter situation in all 3 matches:
            ...
            // We can win 1 match:
            if (
              matches[0]?.matchValue?.indexOf(V2) - dice < 1 &&
              matches[1]?.matchValue?.indexOf(V2) - dice > 0 &&
              matches[2]?.matchValue?.indexOf(V2) - dice > 0
            ) {
              // Choose match1:
              setSelectedMatch(matches[0].matchName);
            } else if (
              matches[0]?.matchValue?.indexOf(V2) - dice > 0 &&
              matches[1]?.matchValue?.indexOf(V2) - dice < 1 &&
              matches[2]?.matchValue?.indexOf(V2) - dice > 0
            ) {
              // Choose match2:
              setSelectedMatch(matches[1].matchName);
              ...
              matches[0]?.matchValue?.indexOf(V2) - dice > 0 &&
              matches[1]?.matchValue?.indexOf(V2) - dice > 0 &&
              matches[2]?.matchValue?.indexOf(V2) - dice < 1
            ) {
              // Choose match3:
              setSelectedMatch(matches[2].matchName);
            }
          ...
          // We are better in "match1" and "match2":
            ...
            matches[0]?.matchValue?.indexOf(V2) < 7 &&
            matches[1]?.matchValue?.indexOf(V2) < 7 &&
            matches[2]?.matchValue?.indexOf(V2) > 6
          ) {
            // We win "match1" and "match2":
            if (
              matches[0]?.matchValue?.indexOf(V2) - dice < 1 &&
          ...
          // We are better in "match1" and "match3":
            ...
            matches[0]?.matchValue?.indexOf(V2) < 7 &&
            matches[1]?.matchValue?.indexOf(V2) > 6 &&
            matches[2]?.matchValue?.indexOf(V2) < 7
          ) {
            // We win "match1" and "match3":
            if (
          ...
          // We are better in "match2" and "match3":
            ...
            matches[0]?.matchValue?.indexOf(V2) > 6 &&
            matches[1]?.matchValue?.indexOf(V2) < 7 &&
            matches[2]?.matchValue?.indexOf(V2) < 7
          ) {
            // We win "match2" and "match3":
