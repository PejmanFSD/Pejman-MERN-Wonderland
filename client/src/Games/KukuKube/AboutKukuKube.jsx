          ...
          <div className="cause" style={{ fontSize: "15px" }}>
            <div className="card">
              <div className="card-body m-3">
                ...
                <h4>How to Play</h4>
                <div>
                  In this game, you first choose your preferred color: Blue, Red
                  or Green
                  <br />
                  A board of colored squares will then appear using your
                  selected color.
                  <br />
                  Among all the squares, one has a slightly different opacity,
                  making it a little lighter than the others.
                  <br />
                  Your challenge is to quickly identify and click the square
                  with the different shade to move to the next step.
                </div>
                <div>
                  ...
                  <br />
                  The game contains 12 steps in total, If you successfully
                  complete all 12 steps, you win the game and if you click the
                  wrong square at any step, you lose the game.
                  <br />
                  Below the main board, there are 12 progress squares that
