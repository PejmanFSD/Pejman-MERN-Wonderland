export default function Square({
  ...
  return (
    <button
      style={{
        border:
          userChoice === text && red === 0 && green === 170 && blue === 0
            ? "5px solid black"
            : userChoice === text && red === 170 && green === 0 && blue === 0
              ? "5px solid limegreen"
              : userChoice === text && red === 0 && green === 0 && blue === 170
                ? "5px solid magenta"
                : "1px solid black",
        ...
        color:
          isUniqueSquareRevealed && uniqueSquare === text
            ? "black"
