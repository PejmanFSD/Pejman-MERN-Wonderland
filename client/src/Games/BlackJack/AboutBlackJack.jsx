          ...
          <div className="cause" style={{ fontSize: "15px" }}>
            <div className="card">
              <div className="card-body m-3">
                ...
                <br />
                Pejman automatically matches your bet with the same number of
                chips.
                <br />
                ...
                After receiving your cards, you can choose from the following
                actions:
                <br />
                ...
                <br />
                (after raising, you must take at least one more card before
                standing).
                <h4>Card Values</h4>
                ...
                <br />
                1- You Get BlackJack: If your hand reaches exactly 21, you
                immediately win the round and Pejman does not play.
                <br />
                2- Pejman Gets BlackJack: If Pejman reaches exactly 21, he wins
                the round.
                <br />
                3- You Get Busted: If your hand exceeds 21, you lose the round
                immediately.
                <br />
                4- Pejman Gets Busted: If Pejman’s hand exceeds 21, you win the
                round.
                <br />
                5- Both Hands Are Below 21: If neither player reaches or exceeds
                21, the player with the higher hand value wins.
                <br />
                If both hands are equal:
                <br />
                In Easy Mode, you win the round and in Normal Mode, Pejman wins
                the round.
                <br />
                * Special Rule: Double-Aces-BlackJack
                <br />
                There is one special exception in the game; if a player has
                exactly 2 Aces and chooses the value 11 for both, the hand value
                becomes 21 instead of 22
                <br />
                (This special situation is called Double-Aces-BlackJack).
                <h4>Betting Restrictions</h4>
                Since you control the betting, your bet cannot exceed the
                smaller number of chips owned by either player.
                <br />
                If one player runs out of chips, raising is no longer allowed
                and a message will appear explaining this restriction.
                <br />
                <h4>Card Recycling</h4>
                At the end of each round, used cards are set aside. When the
                deck becomes empty, all previously used cards are shuffled again
                and reused.
                <br />
                <h4>Game Modes</h4>
                ...
                <br />
                - Pejman remembers all previously used cards (but he still does
                not know upcoming cards).
                <br />
                - If both hands have equal value, Pejman wins the round.
                <br />- Win the game to earn 32 stars.
