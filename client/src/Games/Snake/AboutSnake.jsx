export default function AboutSnake({ setIsAboutPage }) {
  ...
  return (
    <div>
      <h2>About Snake</h2>
      In this game, you control a snake moving across a board made up of 400
      grids (20 × 20) using the arrow keys on your keyboard.
      <br />
      At the beginning of the game the snake consists of a single green square
      and a randomly generated red food appears somewhere on the board.
      <br />
      Your goal is to guide the snake toward the food.
      <br />
      <h4>How the Game Works</h4>
      When the snake’s head reaches the red food, the snake grows by one grid
      and at the same time a new food is immediately generated at a random
      location.
      <br />
      As you continue collecting food, The snake becomes longer and the game
      becomes more challenging.
      <br />
      <h4>Winning & Losing</h4>
      You Lose if the snake’s head hits a wall or collides with its own body.
      <br />
