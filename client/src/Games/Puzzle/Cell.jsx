...
export default function Cell({
  ...
  const handleClickCell = () => {
    ...
    if ([6, 7, 8, 11, 12, 13, 16, 17, 18, 21, 22, 23].includes(idx)) {
      if (
        imageGroup.find((i) => i.currentLocation === idx - 5).image !== E00 &&
        imageGroup.find((i) => i.currentLocation === idx - 1).image !== E00 &&
        imageGroup.find((i) => i.currentLocation === idx + 5).image !== E00 &&
        imageGroup.find((i) => i.currentLocation === idx + 1).image !== E00
      ) {
        ...
        setImageGroup((currImageGroup) =>
          currImageGroup.map((i) =>
            i.image === imageSrc ? { ...i, isClicked: false } : i,
          ),
        );
        return;
      }
      ...
      if (
        imageGroup.find((i) => i.currentLocation === 1).image !== E00 &&
        imageGroup.find((i) => i.currentLocation === 5).image !== E00
      ) {
        setIsAnImageClicked(false);
        setImageGroup((currImageGroup) =>
          currImageGroup.map((i) =>
      ...
      if (
        imageGroup.find((i) => i.currentLocation === 3).image !== E00 &&
        imageGroup.find((i) => i.currentLocation === 9).image !== E00
      ) {
        setIsAnImageClicked(false);
        setImageGroup((currImageGroup) =>
          currImageGroup.map((i) =>
      ...
      if (
        imageGroup.find((i) => i.currentLocation === 20).image !== E00 &&
        imageGroup.find((i) => i.currentLocation === 26).image !== E00
      ) {
        setIsAnImageClicked(false);
        setImageGroup((currImageGroup) =>
          currImageGroup.map((i) =>
      ...
      if (
        imageGroup.find((i) => i.currentLocation === 24).image !== E00 &&
        imageGroup.find((i) => i.currentLocation === 28).image !== E00
      ) {
        setIsAnImageClicked(false);
        setImageGroup((currImageGroup) =>
          currImageGroup.map((i) =>
