  ...
  return (
    <div>
      ...
      <div>
        ...
        goal is to guess it correctly.
        <br />
        Since the number is hidden, you must enter your guess using four
        separate input boxes (one digit per box).
        <br />
      ...
      <div>
        ...
        <br />- Obviously, non-digit characters (like the letters of the
        alphabet) are not allowed
      </div>
      <div>
        Each rule has its own unique error message.{" "}
        <em>
          (If you are an employer, feel free to test the different vadivdation
