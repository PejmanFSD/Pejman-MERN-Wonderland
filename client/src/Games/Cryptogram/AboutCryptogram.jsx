export default function AboutCryptogram({ setIsAboutPage }) {
  ...
  return (
    <div>
      ...
      advice, 4 different letters of the alphabet are hidden — regardless of how
      many times each letter appears in the text.
      <br />
      Each hidden letter is replaced with an input box containing a unique code.
      Input boxes that share the same code represent the same letter. Your task
      is to figure out the correct letters and fill in all the input boxes.
      <br />
      ...
      visibly in the advice before submission.
      <br />
      If you enter a letter that is already visible elsewhere in the advice, you
      will receive a warning.
      <br />
      However, you may still submit your answer — though doing so will result in
      losing the game.
      <br />
      <em>
